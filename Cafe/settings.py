...
SECRET_KEY = 'o#j&*959uv6z*=d6(&hmx21y(+01@ie_(5458l89hol)stu1d#'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/home/harsha/Desktop/Cafe/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "static_cafe")
